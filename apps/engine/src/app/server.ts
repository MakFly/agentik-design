...
import type { LiveRunEvent, OrchestratorRunEvent } from "../domains/runs/events";
...
import {
  ...
  deleteProviderKey,
  isSupportedProvider,
} from "../domains/settings/providers-repo";
import {
...
import { withAuth, requirePermission, type AuthVars } from "./middleware/auth";
...
import { listTraces, getTrace } from "../observation/traces";
import {
 ...
 */
async function streamDaemonRunLive(
