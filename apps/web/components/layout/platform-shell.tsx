...
/**
 * Multica platform shell — the business control-plane (served under /{team}/platform/*).
 * Full nav sidebar + topbar. The personal assistant surface uses `AssistantShell` instead.
 */
export function PlatformShell({
  ...
  // The platform segment sits after /{team}/platform/.
